...
//---------------------------------------------------
//사용자가 1~99 입력한 수가 짝수면 => '짝수입니다'
//홀수 => '홀수입니다.
/* const num = window.prompt('1~99 숫자를 입력하세요')
if(num%2===0){
    window.alert('짝수입니다')
}else{
    window.alert('홀수입니다')
...
//비교식 논리연산 비교식
console.log(a===10 && a>=10) //true && ture = ture
console.log(a!==10 && a === 10) //false && ture = false
console.log(a!==10 || a === 10) //false || ture = ture
...
if(score >= Number(90) && score <= Number(100)){
    window.alert('A학점입니다.')
    }else{
        window.alert('F학점입니다.')
    }