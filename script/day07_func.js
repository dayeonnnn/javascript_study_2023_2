...
func1('1234') //호출
//-------------------------------------
//함수 기능 : 리턴(return) 함수 결과값을 외부로 반환명령
function func2(a){
    return a+1 //리턴활용 함수 결과값만 외부로 반환
}
func2(50) //함수결과값을 출력하는 메소드가 없어 출력X
console.log(func2(50)) //함수결과를 호출앞 메소드가 출력O
...
let num2 = 20
function func5(a,b){
    num1 += num2 //n1= n1+n2 =30
    num2 = a+b //n2 =6
    num1 += num2 //n1 = n1+n2 n1=30 n2=6 ->36
    return num1 //36 외부반환
}
...
//함수 = 반복되는 재사용 문법, 매개변수 = 재사용문법 내 수정데이터가 있을 때
