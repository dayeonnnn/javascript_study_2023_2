...
//DOM 이벤트로 함수 호출 시 함수명만 작성한다.(이벤트(click)옆에 쓸때는 괄호 없이 쓰기)
...
//매게변수가 있는 함수를 호출할 경우
//호출함수 괄호안에는 매게변수에 삽입할 데이터를 작성한다.
japangi2('사이다')
japangi2('콜라')
...
function japangi3(drink2,number){
    console.log(drink2+' '+number+'개 나왔습니다')
}
japangi3('사이다','1')
japangi3('콜라','2')
japangi3('사이다','3')
